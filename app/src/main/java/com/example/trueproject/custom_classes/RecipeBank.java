...
public class RecipeBank {
    ...
    static {
        ...
        m.put(7, new Recipe(7,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(46),1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(2), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(47), 1 / 4.0, Unit.SPOON_COFFEE),
                        new IngredientQuantity(IngredientBank.get(7), 2 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(6), 3.5 / 4.0, Unit.SPOON_COFFEE),
                        new IngredientQuantity(IngredientBank.get(42), 2 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(48), 500 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(49), 2 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(50), 100 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(51), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(52), 2 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(53), 300 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(54), 400 / 4.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(55), 200 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(56), 100 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(57), 2 / 4.0, Unit.SPOON_SOUP),
                },
                495,
                RecipeType.MEAT,
                Difficulty.EASY,
        ...
        m.put(8, new Recipe(8,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(58), 1.5 / 4.0, Unit.KG),
                        new IngredientQuantity(IngredientBank.get(59), 1 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(58), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(6), 1/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(29), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(11), 1/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(61), 1/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(62), 2/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(42), 2/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(63), 1/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(5), 100/4.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(7), 2/4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(7), 100/4.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(38), 1/4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(24), 100/4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(64), 150/4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(2), 2/4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(65), 1/4.0, Unit.UNIT),
                },
                905,
                RecipeType.MEAT,
                Difficulty.HARD,
        ...
        m.put(9, new Recipe(9,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(66), 1 / 6.0, Unit.KG),
                        new IngredientQuantity(IngredientBank.get(6), 1.5 / 6.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(67), 3 / 6.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(2), 2/ 6.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(7), 3 / 6.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(68), 150 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(69), 70 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(54), 50 / 6.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(70), 30 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(13), 2 / 6.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(71), 1 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(72), 1 / 6.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(29), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(4), 1 / 6.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(5), 100 / 6.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(73), 1 / 6.0, Unit.EMB),
                        new IngredientQuantity(IngredientBank.get(74), 100 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(75), 300 / 6.0, Unit.G),
                },
                502,
                RecipeType.FISH,
                Difficulty.MEDIUM,
        ...
        m.put(10, new Recipe(10,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(10), 800 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(29), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(60), 1 / 4.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(42), 1 / 4.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(76), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(14), 400 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(40), 150 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(77), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(78), 200 / 4.0, Unit.G),
        ...
        m.put(11, new Recipe(11,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(79), 2 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(7), 2 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(80), 1 / 4.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(12), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(81), 600 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(50), 150 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(9), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(43), 0, Unit.ENOUGH),
        ...
        m.put(12, new Recipe(12,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(82), 1.5 / 4.0, Unit.KG),
                        new IngredientQuantity(IngredientBank.get(67), 120 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(7), 100 / 4.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(16), 500 / 4.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(5), 200 / 4.0, Unit.ML),
                        new IngredientQuantity(IngredientBank.get(2), 2 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(13), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(3), 1 / 4.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(6), 1 / 4.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(83), 200 / 4.0, Unit.G),
                },
                688,
                RecipeType.FISH,
                Difficulty.MEDIUM,
        ...
        m.put(13, new Recipe(13,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(84), 750 / 8.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(62), 1 / 8.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(85), 240 / 8.0, Unit.G),
        ...
        m.put(14, new Recipe(14,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(67), 3 / 6.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(50), 200 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(7), 4 / 6.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(2), 2 / 6.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(86), 2 / 6.0, Unit.SPOON_COFFEE),
                        new IngredientQuantity(IngredientBank.get(29), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(16), 600 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(87), 1 / 6.0, Unit.EMB),
                        new IngredientQuantity(IngredientBank.get(88), 1 / 6.0, Unit.SPOON_DESSERT),
                        new IngredientQuantity(IngredientBank.get(17), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(70), 30 / 6.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(89), 150 / 6.0, Unit.G),
                },
                304,
                RecipeType.VEGETARIAN,
                Difficulty.MEDIUM,
        ...
        m.put(15, new Recipe(15,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(90), 75 / 2.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(72), 3 / 2.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(6), 1 / 2.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(43), 0, Unit.ENOUGH),
                        new IngredientQuantity(IngredientBank.get(7), 1 / 2.0, Unit.SPOON_DESSERT),
                        new IngredientQuantity(IngredientBank.get(57), 0, Unit.ENOUGH),
                },
                161,
                RecipeType.VEGETARIAN,
                Difficulty.EASY,
        ...
        m.put(16, new Recipe(16,
                ...
                new IngredientQuantity[]{
                        new IngredientQuantity(IngredientBank.get(91), 100 / 12.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(32), 50 / 12.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(32), 4 / 12.0, Unit.SPOON_SOUP),
                        new IngredientQuantity(IngredientBank.get(92), 100 / 12.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(72), 1 / 12.0, Unit.UNIT),
                        new IngredientQuantity(IngredientBank.get(93), 200 / 12.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(94), 200 / 12.0, Unit.G),
                        new IngredientQuantity(IngredientBank.get(95), 1 / 12.0, Unit.SPOON_TEA),
                        new IngredientQuantity(IngredientBank.get(6), 1 / 12.0, Unit.SPOON_COFFEE),
